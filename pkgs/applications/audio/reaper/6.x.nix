...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    hash = {
      x86_64-linux = "sha256-iioHvcb1x+1P5ggEDnwyvFS6bBZIxSHJURxedeCXOQg=";
      aarch64-linux = "sha256-q9nv5UwAWRhfv4D88CC+Z7EkA8aGJ2Ack+nUb8pK2s8=";
  ...
  meta = with lib; {
    ...
    maintainers = with maintainers; [ nilscc ];
  };
}
